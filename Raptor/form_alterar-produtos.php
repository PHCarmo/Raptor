...
<div class="conteudo">
	<?php
		...
		$sqlconsulta = $pdo->prepare("select * from `bd_convenes`.`tb_produto` where IDProduto = :codigo;");
	...
	<form name="form" method="post" action="alterar-produtos.php">
			<center><h2>Produtos</h2></center><h3>

			<table cellspacing="20"><tbody><tr><td>
				<table cellspacing="10">
					<tr><td>Id Produto<br><input type="text" name="idpr" min="0" value="<?php echo $dados['IDProduto']; ?>" id="campos" placeholder="Ex.: 12" readonly></td></tr>	

					<tr><td>Nome<br><input type="text" name="nome" id="campos" placeholder="Ex.: Celular" value="<?php echo $dados['NomeProduto']; ?>"></td></tr>

					<tr><td>Descrição<br><input type="text" name="desc" id="campos" placeholder="Ex.: Azul, 30cm" value="<?php echo $dados['DescricaoProduto']; ?>"></td></tr>

					<tr><td>Validade<br><input type="text" name="vali" id="campos" placeholder="Ex.: 15/04/2018" value="<?php echo $dados['DTValProduto']; ?>"></td></tr>

					<tr><td>Preço<br><input type="text" name="prec" id="campos" placeholder="Ex.: R$20,00" value="<?php echo $dados['PrecoProduto']; ?>"></td></tr>

					<tr><td>Quantidade<br><input type="text" name="quan" min="0" id="campos" placeholder="Ex.: 12" value="<?php echo $dados['QtdProduto']; ?>"></td></tr>
					
					<tr><td>Id Fornecedor<br><input type="text" name="idfo" min="0" id="campos" placeholder="Ex.: 12" value="<?php echo $dados['IDFornecedor']; ?>"></td></tr>
				</tbody></table>
				</td>
