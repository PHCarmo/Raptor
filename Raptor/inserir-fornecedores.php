...
<div class="conteudo">
	...
	<?php
		...
		$sql = "insert into `bd_convenes`.`tb_fornecedores` 
				(IDFornecedor, NomeFornecedor, CNPJFornecedor, IEFornecedor, EnderecoFornecedor, TelefoneFornecedor, EmailFornecedor) 
				values
				(:IDFornecedor, :NomeFornecedor, :CNPJFornecedor, :IEFornecedor, :EnderecoFornecedor, :TelefoneFornecedor, :EmailFornecedor)";
		...
		$sqlinsert ->bindParam(':NomeFornecedor', $_POST['nome'], PDO::PARAM_STR);		
		$sqlinsert ->bindParam(':CNPJFornecedor', $_POST['cnpj'], PDO::PARAM_STR);	
		$sqlinsert ->bindParam(':IEFornecedor', $_POST['insc'], PDO::PARAM_STR);       
		$sqlinsert ->bindParam(':EnderecoFornecedor', $_POST['ende'], PDO::PARAM_STR);    
		$sqlinsert ->bindParam(':TelefoneFornecedor', $_POST['tele'], PDO::PARAM_STR);
		$sqlinsert ->bindParam(':EmailFornecedor', $_POST['emai'], PDO::PARAM_STR); 
