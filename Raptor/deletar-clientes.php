...
<div class="conteudo">
	<?php
		...
		$sqlconsulta = $pdo->prepare("delete from  `bd_convenes`.`tb_clientes` where IDCliente = :codigo;");
	...
	<a href="clientes.php"><input type="button" id="botao" value="Voltar"></a>
</div>
<div class="espaco"></div>
</center>
</body>
