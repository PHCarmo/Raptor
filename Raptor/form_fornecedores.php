...
<div class="conteudo">
	<center>
		<form name="form" method="post" action="inserir-fornecedores.php">
			<center><h2>Fornecedores</h2></center><h3>

			<table cellspacing="20"><tbody><tr><td>
				<table cellspacing="20">
				<tr><td>ID Fornecedor<br><input type="text" name="idfo" id="campos" placeholder="Ex.: 32"></td></tr>

				<tr><td>CNPJ<br><input type="text" name="cnpj" id="campos" placeholder="Ex.: 90.132.169/0001-98"></td></tr>

				<tr><td>Nome<br><input type="text" name="nome" id="campos" placeholder="Ex.: Samsung"></td></tr>
				...
				<tr><td>Inscrição Estadual<br><input type="text" name="insc" id="campos" placeholder="Ex.: 388.108.598.269"></td></tr>
				</tbody></table>
				</td>
